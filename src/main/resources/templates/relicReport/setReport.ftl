        ...
        <div class="layui-form-item" style="text-align:center">
            <div class="layui-upload-list">
                <#if relicDTO.imgUrl?? && relicDTO.imgUrl != ''>
                    <img class="layui-upload-img" id="relic-upload-img"
                         src="/uploadImage/getImgPath?imgUrl=${relicDTO.imgUrl!''}"
                         style="width: 400px; height: 400px;top:0;left:0;z-index: 0;margin:0px;">
