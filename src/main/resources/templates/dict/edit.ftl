...
<div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin" style="padding: 20px 30px 0 0;">
    <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <select name="dictTypeCode" >
                    <#if typeList??>
                        ...
                        <#list typeList as item>
                            <option value="${item.code}" <#if item.code == dictFieldPO.dictTypeCode>selected</#if>>${item.name}</option>
                        </#list>
                    </#if>
                </select>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="dictName" value="${dictFieldPO.dictName}" lay-verify="required" placeholder="请输入字典名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">排序</label>
            <div class="layui-input-inline">
                <input type="text" name="sort" value="${dictFieldPO.sort}"  lay-verify="required" placeholder="请输入排序" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <input type="hidden" name="id" id="id" value="${dictFieldPO.id}">
